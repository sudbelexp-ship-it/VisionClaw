    ...
    private var hint: some View {
        VStack(spacing: Metrics.small) {
            ...
            Text(live.mode == .guide
                 ? "Подойдите к чему-нибудь и задержитесь — он расскажет сам. Спрашивать вслух тоже "
                   + "можно: «а это что?», а «продолжи» сразу возвращает его к рассказу."
                 : "Спрашивайте вслух про то, что перед вами — или просто покажите пальцем, "
                   + "он сам опишет, на что вы указываете.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
