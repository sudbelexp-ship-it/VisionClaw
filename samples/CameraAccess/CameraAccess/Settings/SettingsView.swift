...
struct SettingsView: View {
    ...
    private var voiceSection: some View {
        Section {
            ...
            if hub.isRunning {
                StatusLine(kind: .good,
                           text: hub.isUsingGlassesMic ? "Сейчас слушают очки" : "Сейчас слушает телефон")
            }
        } header: {
            Text("Голос")
        } footer: {
            ...
            //
            // Про микрофон: настройки здесь больше нет — очки слушают всегда, пока подключены, для
            // ассистента, чата, эфира и переводчика одинаково. Единственное, что отдаёт микрофон
            // телефону, — это когда сам телефон играет музыку, видео или голосовое сообщение.
            Text("Язык, который слушает микрофон в чате и в голосовых командах. Скачивается один "
                 + "раз и работает дальше без сети. Пока подключены очки, слушают их микрофоны — во "
                 + "всех режимах, включая переводчик; телефон подхватывает только когда очки не "
                 + "подключены или пока сам телефон воспроизводит музыку, видео или голосовое.")
        }
    }
