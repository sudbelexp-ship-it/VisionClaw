...
final class SimultaneousInterpreter: ObservableObject {
    ...
    func start(source: TranslatorLanguage) async {
        ...
        do {
            ...
            // Никаких флагов: переводчик слушает через микрофон очков весь сеанс, как и любой
            // другой слушатель хаба — это общее правило, а не что-то специфичное для перевода. Хаб
            // отдаёт микрофон только когда сам телефон воспроизводит музыку, видео или голосовое, и
            // это уже не забота этого файла.
